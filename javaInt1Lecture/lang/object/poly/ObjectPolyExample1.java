...
/* Object 본인이 보유한 toString()같은 메서드는 당연히 자식 클래스에서 오버라이딩 할 수 있다.
하지만 Dog.sound()와 같은  메서드를 Object는 오버라이딩을 못하여서
다형적 참조는 가능해도 다형성을 활용하기에는 한계가 있다.
그렇다면 Object를 언제 활용하면 좋을까?
 */
